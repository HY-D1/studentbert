...
**Honest limit:** precise threshold fuzzy (empty gap 0.33-2.41; Algebra2006-07 at pps 2.414 sits inside the originally stated 0.33-2.79 span and closed its upper part). LODO does not generalize at n=6 (leave-one-dataset-out: multivariate 5/6 but overparameterized at n=6, not trustworthy; single features n_students 5/6, pps 3/6. No combo generalizes. NEGATIVE.).
